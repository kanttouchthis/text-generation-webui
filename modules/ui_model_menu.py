                ...
                with gr.Blocks():
                    with gr.Row():
                        with gr.Column():
                            ...
                            shared.gradio['draft_model'] = gr.Dropdown(choices=utils.get_available_models(), value=shared.args.draft_model, label="Draft Model", elem_classes='slim-dropdown', interactive=not mu, info='Draft Model for speculative decoding')
